        ...
        <div className="fixed inset-0 flex justify-center items-center bg-black/40 z-50">
          <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
            ...
            <form className="space-y-3">
              ...
              <input type="number" placeholder="Montant" value={newBill.amount} onChange={(e) => setNewBill({ ...newBill, amount: e.target.value })} className="w-full border px-3 py-2 rounded text-white" />
              <input type="date" placeholder="Date d’échéance" value={newBill.due_date} onChange={(e) => setNewBill({ ...newBill, due_date: e.target.value })} className="w-full border px-3 py-2 rounded text-white" />
              <input type="text" placeholder="URL logo" value={newBill.logo} onChange={(e) => setNewBill({ ...newBill, logo: e.target.value })} className="w-full border px-3 py-2 rounded text-white" />
              <select value={newBill.account_id} onChange={(e) => setNewBill({ ...newBill, account_id: e.target.value })} className="w-full border px-3 py-2 rounded text-white">
